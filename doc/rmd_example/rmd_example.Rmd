...
```{r horse-pops-plot, out.width="80%", fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972"}
...
knitr::kable(horses_sd_table, caption = "SD of Horse Populations by Province in Canada")
```
...
```{r horse-largest-sd, out.width="70%", fig.cap = "Horse populations for the province with the largest standard deviation"}
